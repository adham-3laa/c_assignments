...
namespace DatabaseFirst.Models
{
    public partial class AdventureWorks2012Context
    {
        ...
        public async Task<DateTime?> ufnGetAccountingEndDateAsync()
            => await Database.SqlQueryRaw<DateTime?>("select Value = [dbo].[ufnGetAccountingEndDate]()").SingleAsync();
        ...
        public async Task<DateTime?> ufnGetAccountingStartDateAsync()
            => await Database.SqlQueryRaw<DateTime?>("select Value = [dbo].[ufnGetAccountingStartDate]()").SingleAsync();
