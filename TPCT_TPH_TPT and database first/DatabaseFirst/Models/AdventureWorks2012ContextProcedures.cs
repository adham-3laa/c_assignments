...
namespace DatabaseFirst.Models
{
    ...
    public partial class AdventureWorks2012ContextProcedures : IAdventureWorks2012ContextProcedures
    {
        ...
        public virtual async Task<List<uspGetBillOfMaterialsResult>> uspGetBillOfMaterialsAsync(int? startProductID, DateTime? checkDate, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            ...
            var _ = await _context.SqlQueryToListAsync<uspGetBillOfMaterialsResult>("EXEC @returnValue = [dbo].[uspGetBillOfMaterials] @StartProductID = @StartProductID, @CheckDate = @CheckDate", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<uspGetEmployeeManagersResult>> uspGetEmployeeManagersAsync(int? businessEntityID, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            ...
            var _ = await _context.SqlQueryToListAsync<uspGetEmployeeManagersResult>("EXEC @returnValue = [dbo].[uspGetEmployeeManagers] @BusinessEntityID = @BusinessEntityID", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<uspGetManagerEmployeesResult>> uspGetManagerEmployeesAsync(int? businessEntityID, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            ...
            var _ = await _context.SqlQueryToListAsync<uspGetManagerEmployeesResult>("EXEC @returnValue = [dbo].[uspGetManagerEmployees] @BusinessEntityID = @BusinessEntityID", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<uspGetWhereUsedProductIDResult>> uspGetWhereUsedProductIDAsync(int? startProductID, DateTime? checkDate, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            ...
            var _ = await _context.SqlQueryToListAsync<uspGetWhereUsedProductIDResult>("EXEC @returnValue = [dbo].[uspGetWhereUsedProductID] @StartProductID = @StartProductID, @CheckDate = @CheckDate", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<uspSearchCandidateResumesResult>> uspSearchCandidateResumesAsync(string searchString, bool? useInflectional, bool? useThesaurus, int? language, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            ...
            var _ = await _context.SqlQueryToListAsync<uspSearchCandidateResumesResult>("EXEC @returnValue = [dbo].[uspSearchCandidateResumes] @searchString = @searchString, @useInflectional = @useInflectional, @useThesaurus = @useThesaurus, @language = @language", sqlParameters, cancellationToken);
